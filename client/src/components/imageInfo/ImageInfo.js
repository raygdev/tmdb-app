...
export const ImageInfo = ({ styles, info, imgUrl, releaseDate }) => {
  ...
  return (
    <div className={ImageStyles.movie_info_container} style={{
        ...styles,
        backgroundImage: info.backdrop_path && `url(${imgUrl}${info.backdrop_path})`,
      }}>
          ...
          <div className={ImageStyles.img_col}>
            <figure>
              ...
              <div className={ImageStyles.captions}>
                ...
                { info.runtime ?<figcaption>{info.runtime} minutes</figcaption>: <figcaption>Not Available</figcaption>}
              </div>
            </figure>
          </div>
